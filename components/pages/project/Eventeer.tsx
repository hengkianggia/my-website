        ...
        <ul className="flex flex-col gap-10">
          <li className="relative">
            ...
            <p>
              ...
              that the site can be accessed comfortably on various devices, from
              desktops to smartphones. In this case, I took the following steps:
            </p>
            <ul className="relative ml-10 max-md:ml-4  mt-2 space-y-2 list-disc">
              ...
              <li>
                Testing on Various Devices: To ensure that all pages were truly
                responsive, I conducted tests on various devices and screen
                resolutions, including mobile and tablet simulations.
              </li>
            </ul>
          ...
          <li className="relative">
            ...
            <p>
              The `My Files` feature is an important addition that allows users
              to manage their files directly from the Eventeer platform. Here
              are the steps I took to implement this feature:
            </p>
            <ul className="relative ml-10 max-md:ml-4  mt-4 space-y-2 list-disc">
              ...
              <li>
                Functional Testing: Ensuring that this feature runs smoothly and
                according to the predetermined flow.
              </li>
            </ul>
          ...
          <li className="relative">
            ...
            <p>
              Security is an important aspect in event management, especially in
              preventing spam and abuse. I implemented Google reCAPTCHA to
              improve security by:
            </p>
            <ul className="relative ml-10 max-md:ml-4  mt-4 space-y-2 list-disc">
              <li>
              ...
              <li>
                User Experience Testing: Ensuring that the addition of reCAPTCHA
                does not disrupt the user experience and remains easy to use.
              </li>
            </ul>
            <div className="w-full mt-4 grid place-items-center">
              <Image
          ...
          <li className="relative">
            ...
            <ul className="relative ml-10 max-md:ml-4  mt-4 space-y-2 list-disc">
              <li>
                Pusher Integration: Using Pusher as a service to send real-time
                notifications. This includes creating notification channels and
                events.
              </li>
              <li>
                Front-end Development: Adding client-side support for receiving
                and displaying notifications. This includes developing UI
                components that display notifications in a responsive and
                engaging manner.
              </li>
              <li>
